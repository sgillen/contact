...
trial_path = "/run_stable/data/linear_z/ppo/ppo_cmp2"
...
for model, seed in zip([model_list[4]], [seed_list[4]]):
    for trial in range(10):
        ...
        savemat(f"/run_stable/data_katie/agent-{seed}/ic-{trial}.mat", {"obs_hist":np.array(obs_hist), "act_hist":np.array(act_hist), "xyz_hist":xyz_hist, "contact_list":contact_list, "total_steps":total_steps})
