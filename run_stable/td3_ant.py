...
import json
import pybulletgym
import pybulletgym.envs.mujoco.envs.locomotion.ant_env
from seagul.envs.wrappers.pybullet_physics import PyBulletPhysicsWrapper
import pybullet as p
num_steps = int(2e6)

base_dir = "./data_pbant/td3/"
...
env_kwargs = {'env':gym.make('AntBulletEnv-v0'), 'physics_params':physics_params, 'dynamics_params':dynamics_params}
